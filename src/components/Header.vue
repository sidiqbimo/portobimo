  ...
  <header :class="['w-full h-16 bg-[#F8FFE0] flex items-center justify-between px-6 md:px-[54px] fixed top-0 left-0 right-0 z-50 transition-all duration-500', { 'border-animated': scrolledPastHero, 'fade-out': !scrolledPastHero }]">
   ...
   <div class="flex gap-0.25">
    ...
    <nav class="hidden md:flex gap-8">
      ...
      <a @click.prevent="scrollToContact" class="text-[#A9C46C] text-base font-bold font-['Lato']  hover:font-black hover:text-lg hover:cursor-pointer duration-300 ease-in-out">CONTACT</a>
      <a href="https://drive.google.com/drive/folders/1sZKWVruySKDAxTh5Tpl1gkYe8IJL9TgL?usp=drive_link" class="text-[#5D8736] text-base font-['Lato'] font-bold  hover:font-black hover:text-lg transition-all">MY RESUME</a>
    </nav>
